...
var file_PublicIncreaseDepthsBatchV3Api_proto_rawDesc = []byte{
	...
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x42, 0x56, 0x0a, 0x1c, 0x63, 0x6f, 0x6d,
...
var file_PublicIncreaseDepthsBatchV3Api_proto_goTypes = []interface{}{
...
func file_PublicIncreaseDepthsBatchV3Api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_PublicIncreaseDepthsBatchV3Api_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PublicIncreaseDepthsBatchV3Api); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
