...
var file_PublicAggreDealsV3Api_proto_rawDesc = []byte{
	...
	0x03, 0x52, 0x04, 0x74, 0x69, 0x6d, 0x65, 0x42, 0x4d, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x6d,
...
var file_PublicAggreDealsV3Api_proto_goTypes = []interface{}{
...
func file_PublicAggreDealsV3Api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_PublicAggreDealsV3Api_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PublicAggreDealsV3Api); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_PublicAggreDealsV3Api_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PublicAggreDealsV3ApiItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
