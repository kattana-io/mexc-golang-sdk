...
var file_PublicMiniTickerV3Api_proto_rawDesc = []byte{
	...
	0x77, 0x42, 0x4d, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x78, 0x63, 0x2e, 0x70, 0x75, 0x73,
...
var file_PublicMiniTickerV3Api_proto_goTypes = []interface{}{
...
func file_PublicMiniTickerV3Api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_PublicMiniTickerV3Api_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PublicMiniTickerV3Api); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
