...
var file_PublicLimitDepthsV3Api_proto_rawDesc = []byte{
	...
	0x42, 0x4e, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x78, 0x63, 0x2e, 0x70, 0x75, 0x73, 0x68,
	...
	0x01, 0x5a, 0x0d, 0x77, 0x65, 0x62, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2f, 0x64, 0x74, 0x6f,
...
var file_PublicLimitDepthsV3Api_proto_goTypes = []interface{}{
...
func file_PublicLimitDepthsV3Api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_PublicLimitDepthsV3Api_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PublicLimitDepthsV3Api); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_PublicLimitDepthsV3Api_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PublicLimitDepthV3ApiItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
