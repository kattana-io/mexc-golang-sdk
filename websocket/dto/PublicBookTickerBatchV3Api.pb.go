...
var file_PublicBookTickerBatchV3Api_proto_rawDesc = []byte{
	...
	0x33, 0x41, 0x70, 0x69, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x42, 0x52, 0x0a, 0x1c, 0x63,
	...
	0x5a, 0x0d, 0x77, 0x65, 0x62, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2f, 0x64, 0x74, 0x6f, 0x62,
...
var file_PublicBookTickerBatchV3Api_proto_goTypes = []interface{}{
...
func file_PublicBookTickerBatchV3Api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_PublicBookTickerBatchV3Api_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PublicBookTickerBatchV3Api); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
